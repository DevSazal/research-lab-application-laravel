                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <!-- <label>Title</label> -->
                                                <input type="text" class="form-control border-input {{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="Research Title" name="title" value="{{ $research->title }}" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" rows="5" class="form-control border-input {{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="Here can be your research description" value="Mike">{{ $research->description }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control border-input {{ $errors->has('exp') ? ' is-invalid' : '' }}" placeholder="" name="exp" value="{{ \Carbon\Carbon::parse($research->expire_at)->format('Y-m-d') }}" required>
