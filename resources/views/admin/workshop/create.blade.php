...
@section('title', 'Add Awareness Program - ')
@section('pagetitle', 'New Awareness Program')
...
<form action="{{ route('admin.awareness.store') }}" method="post" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="header" style="padding-bottom: 20px;">
                                <h4 class="title"><b>Write Program Information<b></h4>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input {{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="Program Title" name="title" value="{{ old('title') }}" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" rows="5" class="form-control border-input {{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="Here can be your program description" value="">{{ old('description') }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control border-input {{ $errors->has('start_time') ? ' is-invalid' : '' }}" placeholder="" name="start_time" value="{{ old('start_time') }}" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="venue" rows="5" class="form-control border-input {{ $errors->has('venue') ? ' is-invalid' : '' }}" placeholder="Here can be venue information" value="">{{ old('venue') }}</textarea>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-info btn-fill btn-wd">Save Program</button>
                                    </div>
                                    <div class="clearfix"></div>
